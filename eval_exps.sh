...
# random_walk
# python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type random_walk_30deg_1seed &
# python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type random_walk_30deg_1seed &
# python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type random_walk_30deg_1seed &
# wait
# python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type random_walk_30deg_3seed &
# python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type random_walk_30deg_3seed &
# python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type random_walk_30deg_3seed &
# wait
# python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type step_10deg &
# python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type step_10deg &
# python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type step_10deg &
# wait
# python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type sine_freq_variation &
# python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type sine_freq_variation &
# python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type random_walk_30deg_3seed --eval_type sine_freq_variation &
# wait

python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type random_walk_30deg_1seed &
python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type random_walk_30deg_1seed &
python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type random_walk_30deg_1seed &
wait
python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type random_walk_30deg_3seed &
python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type random_walk_30deg_3seed &
python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type random_walk_30deg_3seed &
wait
python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type step_10deg &
python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type step_10deg &
python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type step_10deg &
wait
python evaluate.py --ftype 0 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type sine_freq_variation &
python evaluate.py --ftype 1 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type sine_freq_variation &
python evaluate.py --ftype 2 --model_dir exp/random_walk --data_type sine_freq_variation --eval_type sine_freq_variation &
wait